...
class nusoap_base {
    ...
    * @access	public
	*/
	function serialize_val($val,$name=false,$type=false,$name_ns=false,$type_ns=false,$attributes=false,$use='literal',$soapval=false) {
    ...
    * @access public
    */
    function serializeEnvelope($body,$headers=false,$namespaces=array(),$style='rpc',$use='literal',$encodingStyle='http://schemas.xmlsoap.org/soap/encoding/'){
...
class wsdl extends nusoap_base {
	...
	*/
	 ...
	 * @access private
	 */
	function serializeType($name, $type, $value, $use='literal', $encodingStyle=false, $unqualified=false)
	{
	 ...
	 * @access private
	 */
	function serializeComplexTypeElements($typeDef, $value, $ns, $uqType, $use='literal', $encodingStyle=false) {
	...
	* @access public 
	*/
	function addOperation($name, $in = false, $out = false, $namespace = false, $soapaction = false, $style = 'rpc', $use = 'literal', $documentation = '', $encodingStyle = ''){
		if ($use == 'encoded' && $encodingStyle == '') {
			$encodingStyle = 'http://schemas.xmlsoap.org/soap/encoding/';
		}
...
class nusoap_client extends nusoap_base  {
	...
	* @access   public
	*/
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='literal'){
